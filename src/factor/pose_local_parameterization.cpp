...
//  This is correct! This jacobian should be 4*3 matrix and be the transpose
//  matrix of lift jacobian matrix(3*4) In projectotion_factor we can deduce the
//  lift jacobian is [I3 0].
